...
public class ProductController {
	...
	//vieno produkto gavimas
		...
		@ApiOperation(value = "Get products", notes = "Returns existing products")
		public ProductData getProductById(@ApiParam(value = "Product id", required = true) @Valid @PathVariable final long id) {
	...
	public void createProduct(
		...
		productService.createProduct(cmd.getTitle(), cmd.getPrice(), cmd.getQuantity(), cmd.getImage(), cmd.getDescription());
		System.out.println("--------------------iš produkto kūrimo" + cmd);
	}
	...
	public void updateProduct(@ApiParam(value = "Product id", required = true) @Valid @PathVariable final long id,
		...
		productService.updateProduct(id, cmd.getTitle(), cmd.getPrice(), cmd.getQuantity(), cmd.getImage(), cmd.getDescription());
